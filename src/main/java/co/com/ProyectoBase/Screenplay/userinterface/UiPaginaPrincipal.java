...
public class UiPaginaPrincipal {
    ...
    public static final Target LBL_CANTIDA_LETRA = Target.the("Campo que contiene la cantidad de veces a ingresar la letra").located(By.xpath("//p[@class = 'text-center text-xl'][1]"));
